//Write java program which accept N numbers from user and accept one another as NO,return index of first occurance of that NO
...
class Program342
{
    public static void main(String as[])
    {
        ...
        {
            System.out.print(iNo+" is present in array at "+iRet+" index");
        }
